...
idleXml = 'idle0';--you can leave this blank if you're using danceLeft and danceRight
leftXml = 'left0';
downXml = 'down0';
upXml = 'up0';
rightXml = 'right0';
...
nameOfPng = 'dave_sheet';
tagForChar = 'unbindingdave';
...
function onUpdate(elapsed)
	if curStep >= 1151 then
		...
		doTweenAlpha('unbind3', tagForChar, 1, 40)
		doTweenAngle('floatu3a', tagForChar, 0-45*math.cos((currentBeat+1)*math.pi), 4)
	end
end
