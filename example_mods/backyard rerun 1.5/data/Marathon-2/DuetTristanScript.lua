...
nameOfPng = 'TRISTAN';
tagForChar = 'DuetTristan';
noteTypeForChar = 'TristanNote';
...
function onUpdate()
	if curStep == 17377 then --tristan appear
		addLuaSprite(tagForChar, inFront)
    end
	if curStep == 18420 then --tristan begone
		removeLuaSprite(tagForChar, inFront)
    end
end
